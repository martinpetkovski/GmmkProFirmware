...
/*[EMPTY] = LAYOUT(
    ...
    [MP_QWERTY] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,  KC_BSLS,           EX_HRES,
